...
var Testimonial = function () {
    return ((0, jsx_runtime_1.jsxs)("div", { className: "bg-gray-100 py-20", children: [" ", (0, jsx_runtime_1.jsxs)("div", { className: "container mx-auto text-center", children: [(0, jsx_runtime_1.jsx)("h2", { className: "text-4xl font-bold mb-10", children: "What Our Alumnis Say" }), (0, jsx_runtime_1.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8", children: testimonials.map(function (testimonial) { return ((0, jsx_runtime_1.jsxs)("div", { className: "bg-white shadow-lg rounded-lg p-6 flex flex-col items-center", children: [(0, jsx_runtime_1.jsx)("img", { src: testimonial.imgSrc, alt: testimonial.name, className: "w-34 h-34 rounded-full mb-4 object-cover" }), (0, jsx_runtime_1.jsx)("h4", { className: "font-bold mt-4", children: testimonial.name }), (0, jsx_runtime_1.jsx)("h5", { className: "text-gray-500 mt-1", children: testimonial.title }), (0, jsx_runtime_1.jsxs)("p", { className: "text-gray-600 italic text-center mt-5", children: ["\"", testimonial.feedback, "\""] })] }, testimonial.id)); }) })] })] }));
};
